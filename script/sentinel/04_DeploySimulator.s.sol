...
/// @notice Deploy skript pro Simulator.
/// Vyžaduje env proměnnou SENTINEL_HOOK_ADDRESS a soubor frontend/v4-addresses.json
/// zapsaný skriptem 00_DeployV4.s.sol.
/// Na konci zapíše frontend/addresses.json.
contract DeploySimulatorScript is Script {
    function run() external {
        address hookAddr = vm.envAddress("SENTINEL_HOOK_ADDRESS");
